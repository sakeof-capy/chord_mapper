...
fn minor_chord_mapping_test() {
    ...
    assert_equal(map_chord_to_notes(MinorChord(ASHARP)), vec![BFLAT, DFLAT, F]);
    ...
    assert_equal(map_chord_to_notes(MinorChord(CSHARP)), vec![DFLAT, E, AFLAT]);  
    assert_equal(map_chord_to_notes(MinorChord(D)), vec![D, F, A]);  
    assert_equal(map_chord_to_notes(MinorChord(EFLAT)), vec![EFLAT, GFLAT, BFLAT]);  
    assert_equal(map_chord_to_notes(MinorChord(DSHARP)), vec![EFLAT, GFLAT, BFLAT]);  
    ...
    assert_equal(map_chord_to_notes(MinorChord(FSHARP)), vec![GFLAT, A, DFLAT]);  
...
fn major_chord_mapping_test() {
    ...
    assert_equal(map_chord_to_notes(MajorChord(CSHARP)), vec![DFLAT, F, AFLAT]);  
    ...
    assert_equal(map_chord_to_notes(MajorChord(DSHARP)), vec![EFLAT, G, BFLAT]);  
    assert_equal(map_chord_to_notes(MajorChord(E)), vec![E, GSHARP, B]);  
    assert_equal(map_chord_to_notes(MajorChord(F)), vec![F, A, C]);  
    assert_equal(map_chord_to_notes(MajorChord(GFLAT)), vec![GFLAT, ASHARP, DFLAT]);  
    assert_equal(map_chord_to_notes(MajorChord(FSHARP)), vec![GFLAT, ASHARP, DFLAT]);  
